...
Deze tekst komt uit mijn blog waarin ik regelmatig schrijf over [Democratie en Onderwijs](https://democratieenonderwijs.netlify.app). Eind november schreef ik deze tekst bijvoorbeeld als een recentie over het boek *De kracht van gras. Walt Whitman en onze tijd* van Jan-Hendrik Bakker. Deze tekst wilde ik passend opmaken in `Typst` en `Quarto`. In deze [map](https://github.com/Jonkman1/TypstandQuarto) zit de file **Richtlijnenvoordetoekomst.qmd** waarmee deze tekst is opgemaakt. Een korte toelichting daarop:
